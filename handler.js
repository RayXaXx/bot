...
export async function callUpdate(callUpdate) {
   ...
   let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;©RɑyXɑXx-BOT;;;\nFN:©RɑyXɑXx-BOT\nORG:©RɑyXɑXx-BOT\nTITLE:\nitem1.TEL;waid=5212412377467:+521 241 237 7467\nitem1.X-ABLabel:©RɑyXɑXx-BOT\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:©RɑyXɑXx-BOT\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: '©RɑyXɑXx-BOT', contacts: [{ vcard }] }}, {quoted: callmsg})
...
global.dfail = (type, m, conn) => {
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: '©RɑyXɑXx-BOT', thumbnail: imagen6, sourceUrl: 'https://github.com/RayXaXx/bot' }}}}, aa)
