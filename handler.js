...
export async function callUpdate(callUpdate) {
   ...
   let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;©RayXaXx-BOT;;;\nFN:©RayXaXx-BOT\nORG:©RayXaXx-BOT\nTITLE:\nitem1.TEL;waid=51902061233:+51 902 061 233\nitem1.X-ABLabel:©RayXaXx-BOT\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:©RayXaXx-BOT\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: '©RayXaXx-BOT', contacts: [{ vcard }] }}, {quoted: callmsg})
...
global.dfail = (type, m, conn) => {
    let msg = { 
       ...
       admin: 'ᴱˢᵗᵉ ᶜᵒᵐᵃⁿᵈᵒ ˢᵒˡᵒ ᴾᵘᵉᵈᵉ ˢᵉʳ ᵁᵗⁱˡⁱᶻᵃᵈᵒ ᴾᵃʳᵃ ˢᵒˡᵒ ᴬᵈᵐⁱⁿⁱˢᵗʳᵃᵈᵒʳᵉˢ ᴰᵉˡ ᴳʳᵘᵖᵒˢ',
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: '©RayXaXx-BOT', thumbnail: imagen6, sourceUrl: '©RayXaXx' }}}}, aa)
