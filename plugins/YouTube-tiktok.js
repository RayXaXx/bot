...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '©RɑyXɑXx-BOT', body: null, thumbnail: imagen1, sourceUrl: '©RɑyXɑXx-BOT' }, mentionedJid: [m.sender]}}}, aa)    
