...
if wget -q https://github.com/RayXaXx/bot/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/RayXaXx/bot.git
...
echo -e "\033[01;32m\033[01mIniciando RayXaXx!!\n\033[0m"
npm start